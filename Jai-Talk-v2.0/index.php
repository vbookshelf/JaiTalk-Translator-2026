...
// ============================================================
// Mic: continuous speech recognition, toggled on/off. Fixed to
...
function stop_recognition() {
    ...
    // Turning the mic off clears whatever was typed/spoken and
    // translated, so the next session starts from a blank slate.

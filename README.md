...
- OS software updates can break a web app e.g. the voice playback can stop working in some browsers, especially when not using the Chrome browser.
...
Version 2.1<br>
5-Aug-2026<br>
- Changed voice interaction to a walkie-talkie style.
